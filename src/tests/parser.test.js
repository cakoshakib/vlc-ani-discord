...
describe('Parses brackets and parenthesis', () => {
  test('Removes brackets', () => {
    const input = '[text here] [more text here] Shingeki no Kyojin - Episode 3 [more text]'
  ...
  test('Removes both parenthesis and brackets', () => {
    const input = '(random text) [more random text] Shingeki no Kyojin (more text) - Episode 3 [ahhh]'
    const result = title_parser(input)
